...
PROMPTS["rag_response_withlength"] = """---Role---
...
You are a helpful assistant responsible for generating a comprehensive summary of the entities and realations provided below.

---Goal---

Given entities and realations in a graph. The realations always contain 2 entities and have a desciption describing the relationship between the two entities.
Please give the graph a comprehensive summary, especially make sure to summarise all the realations.
If the provided descriptions are contradictory, please resolve the contradictions and provide a single, coherent summary.
Make sure it is written in third person, and include the entity names so we the have full context.
...
You are a helpful assistant responsible for deciding witch of the given entities is relevent to the user's query, your answer must came from the given entities, your answer must contain no more the 2 entities.

---Goal---

Given a user query and a number of entities, determine which entities are useful for answering the user's query, your answer must came from the given entities, your answer must contain no more the 2 entities.
Remember, your answer must be among the entities given , you should not give a entity witch is not even in the entities given to you.
...
Query: "How does international trade influence global economic stability?"
entities:""INTERNATIONAL TRADE", "TEDDY" , "GLOBAL ECONOMIC" , "EMERGENCY, INVESMENT""
################
Output:
...
Query: "What is the role of education in reducing poverty?"
entities:""EDUCATION",  "HOLIDAY", "PROVERTY REDUCTION" , "BILLY""
################
Output:

"EDUCATION",  "PROVERTY REDUCTION" 
...
PROMPTS["naive_rag_response_withlength"] = """---Role---
